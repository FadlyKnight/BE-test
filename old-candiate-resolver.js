...
async function UpdateCandidate(
  ...
  if (
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'registered' && candidate_input.candidate_admission_status === 'resigned') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'registered' && candidate_input.candidate_admission_status === 'resigned_after_engaged') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'registered' && candidate_input.candidate_admission_status === 'resigned_after_registered') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'registered' && candidate_input.candidate_admission_status === 'no_show') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'registered' && candidate_input.candidate_admission_status === 'resignation_missing_prerequisites') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'registered' && candidate_input.candidate_admission_status === 'resign_after_school_begins') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'registered' && candidate_input.candidate_admission_status === 'report_inscription')
  ) {
  ...
  if (
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'resigned' && candidate_input.candidate_admission_status === 'registered') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'resigned_after_engaged' && candidate_input.candidate_admission_status === 'registered') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'resigned_after_registered' && candidate_input.candidate_admission_status === 'registered') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'no_show' && candidate_input.candidate_admission_status === 'registered') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'resignation_missing_prerequisites' && candidate_input.candidate_admission_status === 'registered') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'resign_after_school_begins' && candidate_input.candidate_admission_status === 'registered') ||
    (candidate_input.candidate_admission_status && oldCandidate.candidate_admission_status === 'report_inscription' && candidate_input.candidate_admission_status === 'registered')
  ) {
    const candidateFound = await CandidateModel.findById(oldCandidate._id).select('student_id').lean();
    const otherCandidateSameStudent = await CandidateModel.find({ student_id: candidateFound.student_id }).select('_id').lean();
